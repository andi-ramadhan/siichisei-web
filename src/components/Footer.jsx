    ...
    <footer className="min-h-[35vh] w-full font-inter flex flex-col justify-between py-10 px-40 bg-gray-blue">
      <div className="z-10 h-full flex flex-row justify-between gap-10 my-8">
        ...
        <div className="footer-links flex flex-row gap-10 tracking-wide justify-around grow-2 text-md">
          <Link to="/" className="orange-footer-link h-0" onClick={toTop}>Home</Link>
          <nav className="flex flex-col gap-8">
            <ul className="flex flex-col gap-2">
              <NavLink to='/services' className="orange-footer-link">Private Class</NavLink>
          ...
          <nav>
            <ul className="flex flex-col gap-2">
              <NavLink to='/services' className="orange-footer-link">Academy Class</NavLink>
          ...
          <nav>
            <ul className="flex flex-col gap-2">
              <NavLink to='/faqs' className="orange-footer-link">FAQs</NavLink>
              <li><NavLink to='/faqs'>Cari Pertanyaan</NavLink></li>
            </ul>
          </nav>
          <nav>
            <ul className="flex flex-col gap-2">
              <NavLink to='/testimonials' className="orange-footer-link">Testimonials</NavLink>
              <li className="text-wrap"><NavLink to='/testimonials'>Testimoni Siswa <br/>SiiChiSei Academy</NavLink></li>
            </ul>
          </nav>
          <NavLink to='/contact' className="orange-footer-link h-0">Contact</NavLink>
        </div>
      </div>
      {/* bottom container */}
      <div className="text-gray-400 flex flex-col justify-center items-center border-t-1">
        <div className="social-media-container flex gap-3 py-20">
          <div className="social-media-icon">
            <a href="https://www.instagram.com/siichisei_ac" target="_blank">
              <svg 
