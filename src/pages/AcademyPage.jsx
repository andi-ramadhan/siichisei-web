...
const AcademyPage = () => {
  ...
  return(
    <main className="w-full h-full flex flex-col justify-center items-center my-5">
      <div className="container flex flex-col items-center py-10 px-70 min-h-screen overflow-y-auto rounded-lg shadow-2xl font-inter text-gray-600">
        ...
        <div id="academy-welcome" className="flex flex-col items-center h-full pb-10">
          <img 
            ...
            className="w-80"
          />
          <h1 className="text-8xl text-center tracking-wide font-roboto-slab">SiiChiSei<br />Academy</h1>
        ...
        <div id="ongoing-course" className="relative container w-9/10 mt-10 pt-10 pb-20 px-30 flex flex-col shadow-2xl shadow-word-orange/80 bg-gray-blue rounded-t-lg">
          <h4 className="text-md uppercase font-bold text-word-orange tracking-[0.2rem] self-center">On going Course</h4>
